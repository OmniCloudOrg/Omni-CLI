...
async fn main() -> Result<()> {
    ...
    let cli = Command::new("omni")
        .subcommand(Command::new("up").about("Deploy application"))
        .subcommand(Command::new("push").about("Push to registry"))
        .subcommand(Command::new("scale").about("Scale components"))
        .get_matches();
